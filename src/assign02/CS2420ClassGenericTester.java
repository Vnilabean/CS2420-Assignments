...
public class CS2420ClassGenericTester {
    ...
    @Test
    public void testOrderedByScoreHighercutoff() {
        ArrayList<CS2420StudentGeneric<Integer>> actual = phase3Class.getOrderedByScore(69);
    ...
    @Test
    public void testOrderedByScoreWithNoFinalGrade() {
        CS2420StudentGeneric<Integer> tmp = phase3Class.lookup(4);
        tmp.clear();
        ArrayList<CS2420StudentGeneric<Integer>> actual = phase3Class.getOrderedByScore(-1);
        assertEquals(4, actual.size());

        assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 3, 3), actual.get(1));
        assertEquals(new CS2420StudentGeneric<Integer>("A", "B", 2, 2), actual.get(2));
        assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 1, 1), actual.get(0));
        assertEquals(new CS2420StudentGeneric<Integer>("D", "E", 4, 4), actual.get(3));
    }
}